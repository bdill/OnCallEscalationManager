...
exports.handleAdd = function (req, res, next) {
    ...
    // TODO Get from express context
    // TODO http://www.mircozeiss.com/how-to-pass-javascript-variables-from-a-server-to-angular/
    var CurrentUsername = req.param('user');
    var status;
    var foundApplication, newSegment, foundEditor;
    ...
    applicationController.findByName(Name, function (err, application) {
        ...
        // TODO Check for editor, also, why are we doing this assignments?
        foundApplication = application;
        foundEditor = req.param('Editor');
                ...
                if (secondary) {
                    ...
                    .then(function (validatedSecondary) {
                        ...
                        .then(function (segment) {
                            newSegment = segment;
//                            q.nfcall(applicationController.addSegmentEditHistory, foundApplication._id, segment)
//                            .fail(function (err) {
//                                handleError(res, err);
//                            })
//                            .done();

                            return q.nfcall(applicationController.addSegment, foundApplication._id, segment, foundEditor);
                        })
                        .then(function (app) {
