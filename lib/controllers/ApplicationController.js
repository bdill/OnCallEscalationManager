...
exports.addSegment = function (_id, segment, editor, callback) {
    // find by document id and update
    var exists = false;
    Application.findOne({ _id: _id, 'Segments.StartDate': segment.StartDate })
    .exec(function (err, doc) {
        ...
        if (!exists) {
            ...
            var segmentEdit = JSON.parse(JSON.stringify(segment));
            segmentEdit.Action = "add";
            segmentEdit.EditDate = moment();
            segmentEdit.Editor = editor;
